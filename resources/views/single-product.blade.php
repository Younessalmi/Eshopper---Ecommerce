...
<body>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								@foreach ($singlesproduct[0] as $categ)
								<li><a class="active" href="/category/{{$categ->id}}">{{$categ->name}}</a></li>
								@endforeach
							</ul>
						</div>
					</div>
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{Voyager::image(json_decode($singlesproduct[1]->image)[0])}}" alt="" />
								<h3>ZOOM</h3>
							</div>
							<div id="similar-product" class="carousel slide" data-ride="carousel">
								
								  <!-- Wrapper for slides -->
								    @foreach( $singlesproduct as $multiimages )
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<h2>{{$singlesproduct[1]->name}}</h2>
								<p>Web ID: 1089772</p>
								<img src="{{asset('images/product-details/rating.png')}}" alt="" />
								<span>
									<span>{{$singlesproduct[1]->price}}$</span>
									<label>Quantity:</label>
									<input type="number" value="1" />
									<button type="button" class="btn btn-fefault cart">
                                    <a href="/cart/{{$singlesproduct[1]->id}}">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									</p>{!!$singlesproduct[1]->description!!}</p>
    ...
    <script src="{{asset('js/jquery.js')}}"></script>{{asset('')}}
